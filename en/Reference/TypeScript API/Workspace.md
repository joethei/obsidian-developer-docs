...
|  [`on(name: 'quick-preview', callback, ctx)`](on__quick-preview__/on__quick-preview__) |  |  |
|  [`on(name: 'files-menu', callback, ctx)`](on__files-menu__/on__files-menu__) |  | Triggered when the user opens the context menu with multiple files selected in the File Explorer. |
|  [`on(name: 'url-menu', callback, ctx)`](on__url-menu__/on__url-menu__) |  | Triggered when the user opens the context menu on an external URL. |
|  [`on(name: 'editor-menu', callback, ctx)`](on__editor-menu__/on__editor-menu__) |  | Triggered when the user opens the context menu on an editor. |
|  [`on(name: 'editor-change', callback, ctx)`](on__editor-change__/on__editor-change__) |  | Triggered when changes to an editor has been applied, either programmatically or from a user event. |
|  [`on(name: 'editor-paste', callback, ctx)`](on__editor-paste__/on__editor-paste__) |  | Triggered when the editor receives a paste event. Check for <code>evt.defaultPrevented</code> before attempting to handle this event, and return if it has been already handled. Use <code>evt.preventDefault()</code> to indicate that you've handled the event. |
|  [`on(name: 'editor-drop', callback, ctx)`](on__editor-drop__/on__editor-drop__) |  | Triggered when the editor receives a drop event. Check for <code>evt.defaultPrevented</code> before attempting to handle this event, and return if it has been already handled. Use <code>evt.preventDefault()</code> to indicate that you've handled the event. |
|  [`on(name: 'quit', callback, ctx)`](on__quit__/on__quit__) |  | Triggered when the app is about to quit. Not guaranteed to actually run. Perform some best effort cleanup here. |
|  [`on(name: 'resize', callback, ctx)`](on__resize__/on__resize__) |  |  |
|  [`on(name: 'active-leaf-change', callback, ctx)`](on__active-leaf-change__/on__active-leaf-change__) |  |  |
|  [`on(name: 'file-open', callback, ctx)`](on__file-open__/on__file-open__) |  |  |
|  [`on(name: 'layout-change', callback, ctx)`](on__layout-change__/on__layout-change__) |  |  |
|  [`on(name: 'window-open', callback, ctx)`](on__window-open__/on__window-open__) |  |  |
|  [`on(name: 'window-close', callback, ctx)`](on__window-close__/on__window-close__) |  |  |
|  [`on(name: 'css-change', callback, ctx)`](on__css-change__/on__css-change__) |  | Triggered when the CSS of the app has changed. |
|  [`on(name: 'file-menu', callback, ctx)`](on__file-menu__/on__file-menu__) |  | Triggered when the user opens the context menu on a file. |
