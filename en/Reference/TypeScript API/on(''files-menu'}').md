---
aliases: ".on(''files-menu'}')"
cssclasses: hide-title
---

<!-- Do not edit this file. It is automatically generated by API Documenter. -->

[`Workspace`]() › [`on`](/on(''files-menu).md)
...
|  <code>callback</code> | <code>(menu: </code>[`Menu`]()<code>, files: </code>[`TAbstractFile`]()<code>[], source: string, leaf?: </code>[`WorkspaceLeaf`]()<code>) =&gt; any</code> |  |
