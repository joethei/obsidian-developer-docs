---
aliases: ".on(''editor-paste'}')"
cssclasses: hide-title
---

<!-- Do not edit this file. It is automatically generated by API Documenter. -->

[`Workspace`]() › [`on`](/on(''editor-paste).md)
...
|  <code>callback</code> | <code>(evt: </code><code>ClipboardEvent</code><code>, editor: </code>[`Editor`]()<code>, info: </code>[`MarkdownView`]()<code> &#124; </code>[`MarkdownFileInfo`]()<code>) =&gt; any</code> |  |
