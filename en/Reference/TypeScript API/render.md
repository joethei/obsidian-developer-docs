...
|  --- | --- | --- |
|  <code>app</code> | [`App`]() | A reference to the app object |
...
|  <code>component</code> | [`Component`]() | A parent component to manage the lifecycle of the rendered child components. |
