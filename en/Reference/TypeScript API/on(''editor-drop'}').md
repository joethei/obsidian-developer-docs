---
aliases: ".on(''editor-drop'}')"
cssclasses: hide-title
---

<!-- Do not edit this file. It is automatically generated by API Documenter. -->

[`Workspace`]() › [`on`](/on(''editor-drop).md)
...
|  <code>callback</code> | <code>(evt: </code><code>DragEvent</code><code>, editor: </code>[`Editor`]()<code>, info: </code>[`MarkdownView`]()<code> &#124; </code>[`MarkdownFileInfo`]()<code>) =&gt; any</code> |  |
